      ...
      tools: [
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              cfg_scale: { type: 'number', description: 'CFG scale (default: 4)', minimum: 1, maximum: 30 },
              sampler_name: { type: 'string', description: 'Sampling algorithm (default: DPM++ 2M SDE)', default: 'DPM++ 2M SDE' },
              scheduler_name: { type: 'string', description: 'Scheduler algorithm (default: Karras)', default: 'Karras' },
        ...
        switch (request.params.name) {
          case 'generate_image': {
            ...
            const payload: SDAPIPayload = {
              ...
              cfg_scale: args.cfg_scale || 4,
              sampler_name: args.sampler_name || 'DPM++ 2M SDE',
              seed: args.seed ?? -1,
              n_iter: args.batch_size || 1,
              distilled_cfg_scale: args.distilled_cfg_scale || 3.5,
              scheduler: args.scheduler_name || 'Karras',
              tiling: !!args.tiling,
